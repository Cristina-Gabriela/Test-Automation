...
class Employee:
    ...
    def annual_salary(self):
        second_bonus = 1000                 # Variabila cu scop local. In interior va fi vizibila.
...
# set greutate -- input valoare, preprocesare valoare, daca e ok sau nu .
# get - pt a accesa campuri din obiecte.