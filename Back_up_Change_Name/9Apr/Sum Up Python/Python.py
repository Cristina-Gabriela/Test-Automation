...
number = 7
input = input("Enter 'y' if you would like to play")

if input == "y":
    x = int(input("Enter your CNP to enter:"))
    if x == number:
...
dictionar = {"A": 5, "B": 56, "R": 89}
print(list(dictionar.items()))
for i, a in dictionar.items():
    print(f"{i}:{a}")
...
CNP_input = input("Enter your CNP: ")
name_input = input("Enter your name: ")
password = input("Enter your password: ")

_, CNP = extraction_2[CNP_input]
